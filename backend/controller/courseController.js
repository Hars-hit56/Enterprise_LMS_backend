...
// In course controller we create lecture controller we didn't create new controller ok
...
export const removeLecture = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `failed to remove Courses  ${error}` });
  }
};
